...
import { getLegacyPackagePath, getRuntimePath } from './runtime-paths.js';

const LEGACY_JOB_PROFILES_PATHS = [
  getRuntimePath('screening-data', 'job-profiles.json'),
  getLegacyPackagePath('screening-data', 'job-profiles.json'),
];
...
function migrateLegacyJsonIfNeeded() {
  ...
  let initialProfiles = [];
  for (const legacyPath of LEGACY_JOB_PROFILES_PATHS) {
